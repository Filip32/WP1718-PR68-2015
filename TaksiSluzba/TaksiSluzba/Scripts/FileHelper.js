...
var addDriver = "<div class=\"Centar\"><div id= \"error1\" class=\"Red\" ></div ><p style=\"font-weight:bold; font-size:x-large\">Dodaj vozaca<\p><br />";
addDriver += "Korisnicko ime: <br /> <input type=\"text\" id=\"username\" /> <br />";
addDriver += "Lozinka: <br /> <input type=\"password\" id=\"password\" /> <br />";
addDriver += "Ime:<br /> <input type=\"text\" id=\"name\" /> <br />";
addDriver += "Prezime:<br /> <input type=\"text\" id=\"lastname\" /> <br />";
addDriver += "Pol: <br /> <select id=\"pol\"><option value=\"Musko\">Musko</option><option value=\"Zensko\">Zensko</option></select><br />";
addDriver += "JMBG:<br /> <input type=\"text\" id=\"jmbg\" /> <br />";
addDriver += "Kontakt telefon:<br /> <input type=\"text\" id=\"tel\" /> <br />";
addDriver += "Email:<br /> <input type=\"text\" id=\"email\" /> <br />";
addDriver += "Tip automobila: <br /> <select id=\"cartipe\"><option value=\"Putnicko_Vozilo\">Putnicko vozilo</option><option value=\"Kombi_Vozilo\">Kombi vozilo</option></select><br />";
addDriver += "Godiste automobila:<br /><input type=\"text\" id=\"godiste\" /> <br />";
addDriver += "Broj tablica:<br /><input type=\"text\" id=\"tablice\" /> <br />";
addDriver += "Lokacija:<br />";
addDriver += "<div id=\"kord\"></div>";
addDriver += "<div id=\"map\" style=\"height:400px; text-align: center; width:100%\" class=\"map\"></div><script>";
...
addDriver += " xx = coord[0];yy = coord[1]; $(\"#kord\").html(\"[X,Y] = [\" + xx + \",\" + yy + \"]\<br />\");});";
addDriver += "<\/script>";
